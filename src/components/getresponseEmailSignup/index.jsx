          ...
          <div className="container">
            ...
            <div className="row text-center text-sm-left">
              <div className="col-12 col-sm-6 mb-40 mb-sm-0">
                ...
                <div>
                  <textarea
                    className="form-control form-control-light mb-20"
                    placeholder="Input"
                    rows="4"
                  />
                  <div className="icon icon-resize" />
                </div>
              ...
              <div className="col-12 col-sm-6">
                ...
                <div className="socials">
                  <a href=""><img src="img/socials/facebook.svg" /></a>
                  <a href="">
                    <img
                      src="img/socials/twitter.svg"
                    />
                  </a>
                  <a href=""><img src="img/socials/instagram.svg" /></a>
                  <a
                    href=""
                  >
                    <img src="img/socials/behance.svg" />
                  </a>
                  <a href="">
                    <img
